...
#     srv = await loop.create_server(app.make_handler(), '192.168.3.34', 8887)
#     logging.info('server started at http:/192.168.3.34:8887....')
#     return srv
...
async def init(loop):
    ...
    add_static(app)
    # app.router.add_route('GET', '/', index)
    srv = await loop.create_server(app.make_handler(), '192.168.3.34', 8888)
